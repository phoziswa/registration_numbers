describe(' Adding function', function () {
    ...
    // it('should return all the registration numbers when all button is clicled', function () {
    //     var instance = RegNumbersFactory();
        
    //     instance.registrationNums("CY 24689");
    //     instance.registrationNums("CA 12345");
    //     instance.registrationNums("CX 12355");
       
    //     assert.deepEqual(instance.registrationNums(''),["CY 24689","CA 12345","CX 12355"]);
    // });
